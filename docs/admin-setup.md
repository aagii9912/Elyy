# Админ + Эвент landing page — Тохируулгын заавар

Энэ баримт нь `/admin` хэсэг болон эвентийн landing page generator-ыг
production-д (Vercel) ажиллуулах тохиргоог тайлбарлана.
...
- Өгөгдөл: `.data/events.json`, зураг: `public/uploads/` (git-д орохгүй).
