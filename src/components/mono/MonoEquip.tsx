...
/* / — Барилгын бүтэц (Chapter 03).
   ...
   Хоёр pop-up:
     • мета зурвасын баруун захын CTA (`equip.ctaLabel`) → БҮХ тоноглол,
       ...
       зэрэг слайдад ордоггүй инженерийн тоноглол ч багтана. Карт бүрт
       админ бүтээгдэхүүний зураг оруулж болно (заавал биш; зураггүй
       карт зөвхөн бичвэрээр үлдэнэ),
   ...
   `/admin/site` → Барилгын бүтэц, Видеонууд хэсгээс удирдагдана.
...
/* Слайдын ард давтагдан тоглох клип. Админ өөрөө сонгоно
   (`/admin/site` → Видеонууд → «Үндсэн бүтээц»):
