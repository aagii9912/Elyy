  ...
  return (
    ...
    >
      <div className="relative flex h-full w-full overflow-hidden">
        ...
        {/* Бүтэн дэлгэцийн бараан хөшиг ЗОРИУДААР байхгүй — клип бүрэн
            өнгөөрөө харагдана. Бичгийн уншигдац нь үсгэн дээрх сүүдрээр
            (`drop-shadow`) л барина.

            Доод ирмэг нь хуудасны цайвар суурь (`ground`) руу уусна:
            клип хатуу ирмэгээр таслагдахгүй, зөөлөн замхарна. Градиент
            92%-д бүрэн өнгөндөө хүрч, сүүлийн 8% нь тэгш — эс бөгөөс
            уусалтын төгсгөл өөрөө шинэ зурвас болно.

            ⚠ Дараагийн бүлэг (01) нь бараан `night` хөшигөөр нээгддэг
            тул энэ уусалт түүнтэй ӨНГӨӨ ТААРАХГҮЙ — цайвараас бараан
            руу шилжих ирмэг үлдэнэ. Энэ нь ЗОРИУДЫН сонголт (2026-08-30,
            захиалагч). Огтлолтыг бүрэн арилгах шаардлага гарвал бүлэг
            01-ийн `data-veil-in`-г мөн цайвар болгоно. */}
        <div
          aria-hidden
          className="pointer-events-none absolute inset-x-0 bottom-0 z-[5] h-[30vh] bg-gradient-to-b from-ground/0 via-ground/45 via-58% to-ground to-92%"
        />
