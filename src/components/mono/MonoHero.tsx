...
/* / — Intro. Захиалагчийн хоёр 10 секундын клипийг залгасан 20 секундын
   клип — цамхагууд үүр цайхаас нар жаргах хүртэл — ДАВТАГДАН тоглоно.
   ...
   ХОЁР ЭХ ФАЙЛ, нэгийг нь л татна:
     • веб (≥768px)  → hero-loop-desktop.mp4 (1920×1080),
     • гар утас      → hero-loop-mobile.mp4  (1080×1920) — ижил клипийн
       төвийн 9:16 кроп, цамхагууд кадрын төвд.
    ...
    >
      <div className="relative flex h-full w-full overflow-hidden">
        ...
        {/* Бараан хөшиг ЗОРИУДААР байхгүй — клип бүрэн өнгөөрөө
            ...
            Доод ирмэгийн ЦАЙВАР УУСАЛТ (2026-08-31-нд) ХАСАГДСАН: доод
            30vh нь `ground` руу замхардаг байсан нь клипийн доод хэсгийг
            цайруулж, шууд дараа нь ирдэг бараан бүлэг 01-тэй өнгө нь
            зөрдөг байв. Одоо клип доод ирмэг хүртлээ бүтэн өнгөтэй. */}
