        ...
        <li key={`${item.href}-${i}`}>
          ...
          >
            ...
            <svg
              ...
              className="h-3.5 w-3.5 shrink-0 text-white/30 transition-all duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-lime"
            >
