...
/* Хоёр давхар scrim, opacity-гоор солигдоно. Градиентээс градиент руу
   ...
   БҮХ зогсоолын alpha 2 ДАХИН БУУРСАН (ногоон хөшиг хэт тод байсан).
   Зураг өөрөө урагшилж, ногоон нь өнгө засварын filter шиг л үлдэнэ.
   Бичвэрийн контрастыг жинхэнэ кадр дээр ХЭМЖСЭН (canvas-аар зураг +
   CSS filter-ийг нийлүүлж, WCAG харьцаа тооцов):
     • E·L·Y·S үсэг, дээд рельс (α 0.41): 5.1 / 13.6 / 5.1 / 7.8 : 1 —
       самбар бүрийн ХАМГИЙН ЦАЙВАР пикселээр ч 4.6 : 1,
     • хураангуй босоо гарчиг (α 0.41): 8.5 / 10.5 / 5.6 : 1.
   Бүгд 4.5:1-ээс дээш тул жижиг бичвэрт ч хангалттай.

   CAPTION_SCRIM-ийг ХЭВЭЭР үлдээв (доороос үз): гарчиг/тайлбар/товч тэр
   хөшгөн дээрээ суудаг ба түүнийг хагаславал гэрэлтэй интерьер дээр
   контраст ≈2.2:1 хүртэл унана.
...
const SCRIM_IDLE =
  "bg-[linear-gradient(to_top,rgba(22,40,15,0.45)_0%,rgba(22,40,15,0.39)_45%,rgba(22,40,15,0.40)_84%,rgba(22,40,15,0.43)_100%)]";
const SCRIM_ACTIVE =
  "bg-[linear-gradient(to_top,rgba(22,40,15,0.22)_0%,rgba(22,40,15,0.08)_35%,rgba(22,40,15,0.05)_58%,rgba(22,40,15,0.40)_84%,rgba(22,40,15,0.43)_100%)]";
