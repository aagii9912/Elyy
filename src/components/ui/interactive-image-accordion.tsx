...
const SCRIM_IDLE =
  "bg-[linear-gradient(to_top,rgba(22,40,15,0.34)_0%,rgba(22,40,15,0.29)_45%,rgba(22,40,15,0.34)_84%,rgba(22,40,15,0.37)_100%)]";
const SCRIM_ACTIVE =
  "bg-[linear-gradient(to_top,rgba(22,40,15,0.16)_0%,rgba(22,40,15,0.06)_35%,rgba(22,40,15,0.04)_58%,rgba(22,40,15,0.34)_84%,rgba(22,40,15,0.37)_100%)]";
