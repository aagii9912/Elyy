...
export const DEFAULT_SITE_CONTENT: SiteContent = {
  ...
  equip: {
    ...
    equipment: {
      ...
      items: [
        { category: "Радиатор", brand: "E.C.A.", meta: "Турк", logo: "", note: "" },
        { category: "Ханын залгуур", brand: "Legrand", meta: "Франц", logo: "", note: "" },
        { category: "Паркет", brand: "Egger", meta: "Герман", logo: "", note: "" },
        { category: "Ханын цаас", brand: "LX Hausys", meta: "Солонгос", logo: "", note: "" },
        { category: "Цонх", brand: "Veka", meta: "Герман", logo: "", note: "" },
        {
