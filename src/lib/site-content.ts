...
export type SiteContent = {
  ...
  hero: {
    ...
    cinema: {
      ...
      video: string;
      /** Клип тоглохоос ӨМНӨХ кадр. ЗААВАЛ: iOS-ийн эрчим хүч
       *  хэмнэх горим, Safari-ийн бодлого зэрэг autoplay-г хаадаг —
       *  постергүй бол hero бүхэлдээ хоосон хөх дэлгэц болно. Мөн
       *  LCP-д зурах бодит зүйл өгнө. Өөрийн клипийн эхний кадраар
       *  солиход эхлэл нь тасалдалгүй болно. */
      poster: string;
    };
  };
...
export const DEFAULT_SITE_CONTENT: SiteContent = {
  ...
  hero: {
    ...
    cinema: {
      ...
      /* ЗОРИУДААР ХООСОН. Санд байгаа экстерьер зураг бүр тод
         (дундаж гэрэлтүүлэг 135–197/255 — хэмжсэн), тэдгээрийн аль нь ч
         хөх кино композицид зохихгүй бөгөөс цагаан бичгийн контрастыг
         эвдэнэ. Зөв утга нь ӨӨРИЙН клипийн эхний кадр — админаас
         оруулна. Хоосон үед autoplay хаагдвал бичвэр бүрэн уншигдсан
         хэвээр, зөвхөн дүрсгүй үлдэнэ. */
      poster: "",
    },
  },
