...
const mn: Dict = {
  ...
  stats: [
    { value: 440, label: "айлын орон сууц · 4 блок" },
  ...
  developer: {
    ...
    body:
      "Elysium хотхоныг Mongon Construction хэрэгжүүлж байна. Бид 360, Garden, Мандала хотхон зэрэг төслүүдийг чанартай, хугацаандаа амжилттай ашиглалтад оруулсан туршлагатай.",
    label: "Өмнөх төслүүд",
    projects: ["360", "Garden", "Мандала хотхон"],
...
const en: Dict = {
  ...
  hero: {
    ...
    subtitle:
      "Four blocks, 440 residences and 85% shared & open space — a new community designed to live alongside nature.",
    primary: "Book a Visit",
    secondary: "View Apartments",
    scroll: "Scroll",
  },
  stats: [
    { value: 440, label: "residences · 4 blocks" },
